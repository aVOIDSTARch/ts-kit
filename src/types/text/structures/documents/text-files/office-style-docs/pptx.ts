...
// SchemaVersion
import { SemanticVersion } from "../../../../../../classes/classes.js";

const versionNumber: SemanticVersion = new SemanticVersion(1, 0, 0);
...
export interface PptxMeta extends SchemaVersion {}
