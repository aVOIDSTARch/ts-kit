...
export interface CmdBuilder {
    buildRootCommand(root_cmd: RootCommand, root_cmd_options?: CommandOption[], sub_command?: SubCommand[]): FullCommand;
    buildSubCommand(subCmd: SubCommand, sub_cmd_options?: CommandOption[]): SubCommand;
    buildOption(option: CommandOption, option_arguments?: Argument[]): CommandOption[];
    buildArgument(arg: Argument, arg_values?: string[]): Argument[];
